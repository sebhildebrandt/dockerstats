...
export namespace Dockerstats {
  ...
  interface DockerAllData extends DockerContainerData {
    memUsage: number;
    memLimit: number;
    memPercent: number;
    cpuPercent: number;
    ...
    memoryStats: any;
    networks: any;
    processes: DockerContainerProcessData[];
  }
}

export function version(): string;
export function dockerInfo(cb?: (data: Dockerstats.DockerInfoData) => any): Promise<Dockerstats.DockerInfoData>;
export function dockerImages(cb: (data: Dockerstats.DockerImageData[]) => any): Promise<Dockerstats.DockerImageData[]>;
export function dockerImages(all?: boolean, cb?: (data: Dockerstats.DockerImageData[]) => any): Promise<Dockerstats.DockerImageData[]>;
export function dockerContainers(cb: (data: Dockerstats.DockerContainerData[]) => any): Promise<Dockerstats.DockerContainerData[]>;
...
export function dockerContainerStats(cb: (data: Dockerstats.DockerContainerStatsData[]) => any): Promise<Dockerstats.DockerContainerStatsData[]>;
...
export function dockerContainerProcesses(id?: string, cb?: (data: Dockerstats.DockerContainerProcessData[]) => any): Promise<Dockerstats.DockerContainerProcessData[]>;
export function dockerVolumes(cb?: (data: Dockerstats.DockerVolumeData[]) => any): Promise<Dockerstats.DockerVolumeData[]>;
export function dockerAll(cb?: (data: Dockerstats.DockerAllData[]) => any): Promise<Dockerstats.DockerAllData[]>;
